    ...
    describe("api", function () {
        ...
        describe("script tags", function () {
            it("can update script tags", function () {
                ...
                var filteredTags = [].slice.call(existingTags).filter(function (tag) {
                    return Object.is(tag.getAttribute("src"), "http://localhost/test.js") && Object.is(tag.getAttribute("type"), "text/javascript") || Object.is(tag.getAttribute("src"), "http://localhost/test2.js") && Object.is(tag.getAttribute("type"), "text/javascript") || Object.is(tag.getAttribute("type"), "application/ld+json") && Object.is(tag.innerHTML, scriptInnerHTML);
                });
